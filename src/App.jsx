        ...
        <nav className="mainHeader">
          <div className='contentWrapper'>
            ...
            <ul className="mainNav">
              ...
              <li>
                <button className="dropdownBtn" aria-expanded={solutionsState[0]} aria-controls='solutions-menu' onClick={toggleSolutions}>
                  Solutions
                  <svg xmlns="http://www.w3.org/2000/svg" className={solutionsState[1]} 
                  width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <polyline points="9 18 15 12 9 6"></polyline>
                  </svg>
                </button>
            ...
            <ul className='btnHolder'>
              <li><button className='dropdownBtn' id="login">Log in</button></li>
              <li><button className='dropdownBtn' id="signup">Sign up</button></li>
            </ul>
          </div>
        </nav>
      </div>
      <div className="mainContentWrapper">
        <section className='stats-dream'>
          ...
          <div className='rippleHolder'>
            <img className='ripple' src="https://www.digitalocean.com/_next/static/media/surface-water.7a73601a.png" alt="cloud home top center"></img>
          </div>
          <div className='leftHolder'>
            <img className='leftImg' src="https://www.digitalocean.com/_next/static/media/servers-plant-illustration-left.257ba574.svg" alt="cloud home top center"></img>
          </div>
          <div className='rightHolder'>
            <img className='rightImg' src="https://www.digitalocean.com/_next/static/media/servers-plant-illustration-right.0fc693fd.svg" alt="cloud home top center"></img>
          </div>
